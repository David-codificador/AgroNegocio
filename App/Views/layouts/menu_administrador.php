            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="navbar-header no-padding">
                        <a class="navbar-brand" href="<?=LINK?>administrador">
                            MVCPadrao
                        </a>
                            ...
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu profile-dropdown">
                                    <li class="profile-menu bg-gray">
                                        <div class="">
                                            <img src="<?= IMAGEM ?>administrador/<?= $Sessao::getAdministrador("foto") != '' ? $Sessao::getAdministrador("foto") : 'padrao.jpg' ?>" alt="" class="img-circle profile-img" onclick="exibirImg()">
                                            <div class="profile-name">
                                                <h6><?= $Sessao::getAdministrador("nome") ?></h6>
                                                <a><?= $Sessao::getAdministrador("tipo") ?></a>
                                            </div>
                                            <div class="clearfix"></div>
                                        </div>
                                    </li>
                                    <li><a href="<?= LINK ?>administrador/minhasInformacoes"><i class="fa fa-sliders"></i> Minhas informações</a></li>
                                ...
                                <li class="has-children">
                                    ...
                                    <ul class="child-nav">
                                        <li><a href="<?= LINK ?>produtos/cadastro"><i class="fa fa-bars"></i> <span>Cadastro</span></a></li>
                                         <li><a href="<?= LINK ?>produtos/listar"><i class="fa fa-bars"></i> <span>Listagem</span></a></li>
                                    </ul>
                                </li>
                                <li class="has-children">
                                    <a href="#"><i class="fa fa-headphones"></i> <span>Notícias</span> <i class="fa fa-angle-right arrow"></i></a>
                                    <ul class="child-nav">
                                        <li><a href="<?= LINK ?>noticias/cadastro"><i class="fa fa-bars"></i> <span>Cadastro</span></a></li>
                                         <li><a href="<?= LINK ?>noticias/listar"><i class="fa fa-bars"></i> <span>Listagem</span></a></li>
                                    </ul>
                                </li>
                                <li class="has-children">
                                    <a href="#"><i class="fa fa-headphones"></i> <span>Galeria</span> <i class="fa fa-angle-right arrow"></i></a>
                                    <ul class="child-nav">
                                        <li><a href="<?= LINK ?>galeria/cadastro"><i class="fa fa-bars"></i> <span>Cadastro</span></a></li>
                                         <li><a href="<?= LINK ?>galeria/listar"><i class="fa fa-bars"></i> <span>Listagem</span></a></li>
                                    </ul>
                                </li>
                                <li class="has-children">
