                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-sm-12 col-md-8">
                                    <h4 class="mt-0 header-title"><?= $viewVar['paginacao']['quantAdministrador'] ?> Registros<?=$viewVar['paginacao']['quantAdministrador'] == 1 ? '':'s' ?></h4>
                                    <a href="<?= LINK ?>administrador/cadastro" class="btn btn-sm btn-primary">Novo</a>
                                </div>
