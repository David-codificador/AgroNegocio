                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-sm-12 col-md-8">
                                    <h4 class="mt-0 header-title"><?= $viewVar['paginacao']['quanProdutos'] ?> Registros<?= $viewVar['paginacao']['quanProdutos'] == 1 ? '' : 's' ?></h4>
                                    <a href="<?= LINK ?>produtos/cadastro" class="btn btn-sm btn-primary">Novo</a>
                                </div>
                                <div class="col-sm-12 col-md-4">
                                    <div class="col-sm-12 pt-3">
                                        ...
                                        <?= $viewVar['paginacao']['busca'] != '' ? 'Dados da Busca: ' . $viewVar['paginacao']['busca'] . '[<a href="' . LINK . 'produtos/listar/1">Limpar</a>]' : '' ?>
                                    </div>
                                </div>                                
                            </div>
                            ...
                            <table class="table table-hover ">
                                ...
                                <tbody>
                                    ...
                                    foreach ($viewVar['produtos'] as $item) {
                                        ?>
                                        <tr>
                                            <td><img src="<?= IMAGEMSITE ?>produtos/<?= $item['imagem'] != '' ? $item['imagem'] : 'padrao.jpg' ?>" class="img-circle profile-img" width="20%"></td>
                                            <td><?= $item['titulo'] ?></td>
                            ...
                            <nav class="text-center">
                                <ul class="pagination">
                                    ...
                                    ?>">
                                        <a <?php
                                        if ($pagina != 1) {
                                            echo 'href="' . LINK . 'produtos/listar/' . $viewVar['paginacao']['anterior'] . '/' . $viewVar['paginacao']['busca'] . '"';
                                        }
                                        ?> aria-label="Previous">
                                    ...
                                    for ($i; $i < $fim; $i++) {
                                        ...
                                        ?>">
                                            <a href="<?= LINK ?>produtos/listar/<?= $i + 1 ?>/<?= $viewVar['paginacao']['busca'] ?>"><?= $i + 1 ?></a>
                                        </li>
                                        <?php
                                    }
                                    ?>
                                    ...
                                    ?>">
                                        ...
                                        if ($pagina != $total and $fim != 0) {
                                            echo 'href="' . LINK . 'produtos/listar/' . $viewVar['paginacao']['proxima'] . '/' . $viewVar['paginacao']['busca'] . '"';
                                        }
                                        ?> aria-label="Next">
