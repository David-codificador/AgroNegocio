                ...
                <div class="col-md-12">
                    <div class="panel">
                        <div class="panel-body">
                            <form action="<?= LINK ?>noticias/inserir" method="post" class="p-20" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="texto">Texto <sup class="color-danger">*</sup></label>
                                            <textarea class="form-control" id="texto" name="texto" placeholder="Texto" required><?= $Sessao::retornaFormulario("texto") ?></textarea>
                                        </div>
                                    </div>                                   
                                </div>
                                <div class="row">
