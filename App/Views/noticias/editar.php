<div class="main-page">
    <div class="container-fluid">
        <div class="row page-title-div">
            <div class="col-md-12">
                <h2 class="title">Edição de Noticias</h2>
                <p class="sub-title"></p>
            </div>
        </div>
        <div class="row breadcrumb-div">
            <div class="col-md-12">
                <ul class="breadcrumb">
                    ...
                    <li><a href="<?= LINK ?>noticias">Noticias</a></li>
                ...
                <div class="col-md-12">
                    <div class="panel">
                        <div class="panel-body">
                            <form action="<?= LINK ?>noticias/salvar" method="post" class="p-20">
                                <input type="hidden" name="noticias" id="noticias" value="<?= $viewVar['item']['id'] ?>" required>
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="col-md-12">
                                             <img src="<?= IMAGEMSITE ?>noticias/<?= $viewVar['item']['imagem'] != '' ? $viewVar['item']['imagem'] : 'padrao.jpg' ?>" class="img-circle profile-img" width="100%" onclick="exibirImgNoticias('<?= IMAGEMSITE ?>noticias/<?= $viewVar['item']['imagem'] != '' ? $viewVar['item']['imagem'] : 'padrao.jpg' ?>')">
                                        </div>
                                    </div>
                                    <div class="col-md-8">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="titulo" name="titulo" placeholder="Titulo" maxlength="50" value="<?= $viewVar['item']['titulo'] ?>">
                                            </div>
                                        </div>                                       
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="texto">texto</label>
                                                <textarea class="form-control" id="texto" name="texto" placeholder="Texto"><?= $viewVar['item']['texto'] ?></textarea>
                                            </div>
                                        </div>  
                                    </div>                                                                      
                                </div>
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="btn-group pull-right mt-10" role="group">
                                            <a href="<?= LINK ?>noticias/listar" class="btn bg-gray btn-wide"><i class="fa fa-mail-reply"></i>Voltar</a>
...
<div class="modal fade" id="exibirImgNoticias" tabindex="-1" role="dialog" aria-labelledby="exibirImgNoticias">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-body">
                ...
                <br>
                <form action="<?= LINK ?>noticias/editarImagem" method="post" id="uploadImagem" enctype="multipart/form-data">
