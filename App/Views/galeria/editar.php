                ...
                <div class="col-md-12">
                    <div class="panel">
                        <div class="panel-body">
                            <form action="<?= LINK ?>galeria/salvar" method="post" class="p-20" enctype="multipart/form-data">
                                <input type="hidden" name="galeria" id="galeria" value="<?= $viewVar['item']['id'] ?>" required>
                                <h5 class="underline mt-n">Informações: Clique na Imagem para Altera-la</h5>
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="col-md-12">
                                            <img src="<?= IMAGEMSITE ?>galeria/<?= $viewVar['item']['imagem'] != '' ? $viewVar['item']['imagem'] : 'padrao.jpg' ?>" width="40%" onclick="exibirImgGaleria('<?= IMAGEMSITE ?>galeria/<?= $viewVar['item']['imagem'] != '' ? $viewVar['item']['imagem'] : 'padrao.jpg' ?>')" >
                                        </div>
                                    </div>        
                                </div>
...
<div class="modal fade" id="exibirImgGaleria" tabindex="-1" role="dialog" aria-labelledby="exibirImgGaleria">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-body">
                ...
                <br>
                <form action="<?= LINK ?>galeria/editarImagem" method="post" id="uploadImagem" enctype="multipart/form-data">
